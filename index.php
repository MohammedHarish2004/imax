                    ...
                    <div class="home-slideshow slick-arrow-dots">
                        <div class="slide">
                            <div class="slideshow-wrap">
                                <picture>
                                    <source media="(max-width:767px)" srcset="<?php echo $path ?>img\slider\cup11.jpg" width="1150" height="800">
                                    <img class="blur-up lazyload" src="<?php echo $path ?>img\slider\cup1.jpg" alt="slideshow" title="" width="1920" height="795" />
                                </picture> 
                                <!-- <div class="container">
                        ...
                        <div class="slide">
                            <div class="slideshow-wrap">
                                <picture>
                                    <source media="(max-width:767px)" srcset="<?php echo $path ?>img\slider\cup22.jpg" width="1150" height="800">
                                    <img class="blur-up lazyload" src="<?php echo $path ?>img\slider\cup4.jpg" alt="slideshow" title="" width="1920" height="795" />
                                </picture>  
                                <!-- <div class="container">
                        ...
                        <div class="slide">
                            <div class="slideshow-wrap">
                                <picture>
                                    <source media="(max-width:767px)" srcset="<?php echo $path ?>img\slider\cup44.jpg" width="1150" height="800">
                                    <img class="blur-up lazyload" src="<?php echo $path ?>img\slider\cup3.jpg" alt="slideshow" title="" width="1920" height="795" />
                                </picture>  
                                <!-- <div class="container">
                                    <div class="slideshow-content slideshow-overlay middle-right">
                                        <div class="slideshow-content-in">
                    ...
                    <div class="container">
                        ...
                        <div class="category-item zoomscal-hov">
                            <a href="javascript:void(0)" class="category-link clr-none">
                                <div class="zoom-scal zoom-scal-nopb rounded-0"><img class="rounded-0 blur-up lazyload" data-src="<?php echo $path ?>img\used\cup1.jpg" src="<?php echo $path ?>img\used\cup1.jpg" alt="Men's" title="Men's" width="365" height="365" /></div>
                        ...
                        <div class="category-item zoomscal-hov">
                            <a href="javascript:void(0)" class="category-link clr-none">
                                <div class="zoom-scal zoom-scal-nopb rounded-0"><img class="rounded-0 blur-up lazyload" data-src="<?php echo $path ?>img/index\th-3610389770.jpg" src="<?php echo $path ?>img/index\th-3610389770.jpg" alt="Women's" title="Women's" width="365" height="365" /></div>
                                <div class="details text-center">
                        ...
                        <div class="category-item zoomscal-hov">
                            <a href="javascript:void(0)" class="category-link clr-none">
                                <div class="zoom-scal zoom-scal-nopb rounded-0"><img class="rounded-0 blur-up lazyload" data-src="<?php echo $path ?>img/used\cup9.jpg" src="<?php echo $path ?>img/used\cup9.jpg" alt="Top" title="Top" width="365" height="365" /></div>
                                <div class="details text-center">
                        ...
                        <div class="category-item zoomscal-hov">
                            <a href="javascript:void(0)" class="category-link clr-none">
                                <div class="zoom-scal zoom-scal-nopb rounded-0"><img class="rounded-0 blur-up lazyload" data-src="<?php echo $path ?>img/used\cup3.jpg" src="<?php echo $path ?>img/used\cup3.jpg" alt="Bottom" title="Bottom" width="365" height="365" /></div>
                                <div class="details text-center">
                        ...
                        <div class="category-item zoomscal-hov">
                            <a href="javascript:void(0)" class="category-link clr-none">
                                <div class="zoom-scal zoom-scal-nopb rounded-0"><img class="rounded-0 blur-up lazyload" data-src="<?php echo $path ?>img/used\cup7.jpg" src="<?php echo $path ?>img/used\cup7.jpg" alt="T-Shirts" title="T-Shirts" width="365" height="365" /></div>
                                <div class="details text-center">
                        ...
                        <div class="category-item zoomscal-hov">
                            <a href="javascript:void(0)" class="category-link clr-none">
                                <div class="zoom-scal zoom-scal-nopb rounded-0"><img class="rounded-0 blur-up lazyload" data-src="<?php echo $path ?>img/used\cup11.jpg" src="<?php echo $path ?>img/used\cup11.jpg" alt="Shirts" title="Shirts" width="365" height="365" /></div>
                                <div class="details text-center">
                        ...
                        <div class="category-item zoomscal-hov">
                            <a href="javascript:void(0)" class="category-link clr-none">
                                <div class="zoom-scal zoom-scal-nopb rounded-0"><img class="rounded-0 blur-up lazyload" data-src="<?php echo $path ?>img/used\cup3.jpg" src="<?php echo $path ?>img/used\cup3.jpg" alt="Jeans" title="Jeans" width="365" height="365" /></div>
                                <div class="details text-center">
                    ...
                    <div class="container">
                        ...
                        <div class="grid-products grid-view-items mt-5 mb-5">
                                        ...
                                        <div class="product-box">
                                            ...
                                            <div class="product-image">
                                                ...
                                                <a href="javascript:void(0)" class="product-img rounded-0">
                                                    <!-- Image -->
                                                    <img class="primary rounded-0 blur-up lazyload" data-src="<?php echo $path ?>img/index\th-3610389770.jpg" src="<?php echo $path ?>img/index\th-3610389770.jpg" alt="Product" title="Product" width="625" height="808"/>
                                                    <!-- End Image -->
                                                    <!-- Hover Image -->
                                                    <img class="hover rounded-0 blur-up lazyload" data-src="<?php echo $path ?>img/index\th-61153702.jpg" src="<?php echo $path ?>img/index\th-61153702.jpg" alt="Product" title="Product" width="625" height="808"/>
                                                    <!-- End Hover Image -->
                                                </a>
                                                <!-- End Product Image -->
                                                <!--Product Button-->
                                    ...
                                    <div class="item col-item">
                                        <div class="product-box">
                                            ...
                                            <div class="product-image">
                                                ...
                                                <a href="javascript:void(0)" class="product-img rounded-0">
                                                    <!-- Image -->
                                                    <img class="primary rounded-0 blur-up lazyload" data-src="<?php echo $path ?>img/index\cup1.jpg" src="<?php echo $path ?>img/index\cup1.jpg" alt="Product" title="Product" width="625" height="808" />
                                                    <!-- End Image -->
                                                    <!-- Hover Image -->
                                                    <img class="hover rounded-0 blur-up lazyload" data-src="<?php echo $path ?>img/index\cup3.jpg" src="<?php echo $path ?>img/index\cup3.jpg" alt="Product" title="Product" width="625" height="808" />
                                                    <!-- End Hover Image -->
                                                </a>
                                                <!-- End Product Image -->
                                                <!-- Product label -->
                                                    ...
                                                    <div class="addtocart-btn">
                                                        <form class="addtocart" action="#" method="post">
                                                            <a href="#addtocart-modal" class="btn btn-md add-to-cart-modal" data-bs-toggle="modal" data-bs-target="#addtocart_modal">
                                                                <i class="icon anm anm-cart-l me-2"></i><span class="text">Add to Cart</span>
                                                            </a>
                                                        </form>
                                                    </div>
                                                </div>
                                    ...
                                    <div class="item col-item">
                                        <div class="product-box">
                                            ...
                                            <div class="product-image">
                                                ...
                                                <a href="javascript:void(0)" class="product-img rounded-0">
                                                    <!-- Image -->
                                                    <img class="primary rounded-0 blur-up lazyload" data-src="<?php echo $path ?>img/index\th-81932006.jpg" src="<?php echo $path ?>img/index\th-81932006.jpg" alt="Product" title="Product" width="625" height="808" />
                                                    <!-- End Image -->
                                                    <!-- Hover Image -->
                                                    <img class="hover rounded-0 blur-up lazyload" data-src="<?php echo $path ?>img/index\th-61153702.jpg" src="<?php echo $path ?>img/index\th-61153702.jpg" alt="Product" title="Product" width="625" height="808" />
                                                    <!-- End Hover Image -->
                                    ...
                                    <div class="item col-item">
                                        <div class="product-box">
                                            ...
                                            <div class="product-image">
                                                ...
                                                <a href="javascript:void(0)" class="product-img rounded-0">
                                                    <!-- Image -->
                                                    <img class="primary rounded-0 blur-up lazyload" data-src="<?php echo $path ?>img/used\cup9.jpg" src="<?php echo $path ?>img/used\cup9.jpg" alt="Product" title="Product" width="625" height="808" />
                                                    <!-- End Image -->
                                                    <!-- Hover Image -->
                                                    <img class="hover rounded-0 blur-up lazyload" data-src="<?php echo $path ?>img/index\th-2839210236.jpg" src="<?php echo $path ?>img/index\th-2839210236.jpg" alt="Product" title="Product" width="625" height="808" />
                                                    <!-- End Hover Image -->
                                                </a>
                                                <!-- End Product Image -->
                                                <!-- Product label -->
                                    ...
                                    <div class="item col-item">
                                        <div class="product-box">
                                            ...
                                            <div class="product-image">
                                                ...
                                                <a href="javascript:void(0)" class="product-img rounded-0">
                                                    <!-- Image -->
                                                    <img class="primary rounded-0 blur-up lazyload" data-src="<?php echo $path ?>img/used\cup1.jpg" src="<?php echo $path ?>img/used\cup1.jpg" alt="Product" title="Product" width="625" height="808" />
                                                    <!-- End Image -->
                                                    <!-- Hover Image -->
                                                    <img class="hover rounded-0 blur-up lazyload" data-src="<?php echo $path ?>img/used\cup2.jpg" src="<?php echo $path ?>img/used\cup2.jpg" alt="Product" title="Product" width="625" height="808" />
                                                    <!-- End Hover Image -->
                                                </a>
                                                <!-- End Product Image -->
                                                <!-- Product label -->
                                                    ...
                                                    <div class="addtocart-btn">
                                                        <form class="addtocart" action="#" method="post">
                                                            <a href="#addtocart-modal" class="btn btn-md add-to-cart-modal soldOutBtn disabled" data-bs-toggle="modal" data-bs-target="#addtocart_modal">
                                                                <i class="icon anm anm-cart-l me-2"></i><span class="text">Out Of stock</span>
                                                            </a>
                                                        </form>
                                                    </div>
                                                </div>
                                    ...
                                    <div class="item col-item">
                                        <div class="product-box">
                                            ...
                                            <div class="product-image">
                                                ...
                                                <a href="javascript:void(0)" class="product-img rounded-0">
                                                    <!-- Image -->
                                                    <img class="primary rounded-0 blur-up lazyload" data-src="<?php echo $path ?>img/used\cup3.jpg" src="<?php echo $path ?>img/used\cup3.jpg" alt="Product" title="Product" width="625" height="808" />
                                                    <!-- End Image -->
                                                    <!-- Hover Image -->
                                                    <img class="hover rounded-0 blur-up lazyload" data-src="<?php echo $path ?>img/used\cup4.jpg" src="<?php echo $path ?>img/used\cup4.jpg" alt="Product" title="Product" width="625" height="808" />
                                                    <!-- End Hover Image -->
                                                </a>
                                                <!-- End Product Image -->
                                                <!-- Product label -->
                                    ...
                                    <div class="item col-item">
                                        <div class="product-box">
                                            ...
                                            <div class="product-image">
                                                ...
                                                <a href="javascript:void(0)" class="product-img rounded-0">
                                                    <!-- Image -->
                                                    <img class="primary rounded-0 blur-up lazyload" data-src="<?php echo $path ?>img/used\cup5.jpg" src="<?php echo $path ?>img/used\cup5.jpg" alt="Product" title="Product" width="625" height="808" />
                                                    <!-- End Image -->
                                                    <!-- Hover Image -->
                                                    <img class="hover rounded-0 blur-up lazyload" data-src="<?php echo $path ?>img/used\cup6.jpg" src="<?php echo $path ?>img/used\cup6.jpg" alt="Product" title="Product" width="625" height="808" />
                                                    <!-- End Hover Image -->
                                                </a>
                                                <!-- End Product Image -->
                                                <!--Product Button-->
                                    ...
                                    <div class="item col-item">
                                        <div class="product-box">
                                            ...
                                            <div class="product-image">
                                                ...
                                                <a href="javascript:void(0)" class="product-img rounded-0">
                                                    <!-- Image -->
                                                    <img class="primary rounded-0 blur-up lazyload" data-src="<?php echo $path ?>img/used\cup7.jpg" src="<?php echo $path ?>img/used\cup7.jpg" alt="Product" title="Product" width="625" height="808" />
                                                    <!-- End Image -->
                                                    <!-- Hover Image -->
                                                    <img class="hover rounded-0 blur-up lazyload" data-src="<?php echo $path ?>img/used\cup8.jpg" src="<?php echo $path ?>img/used\cup8.jpg" alt="Product" title="Product" width="625" height="808" />
                                                    <!-- End Hover Image -->
                                                </a>
                                                <!-- End Product Image -->
                                                <!-- Product label -->
                            ...
                            <div class="view-collection text-center mt-4 mt-md-5">
                                <a href="javascript:void(0)" class="btn btn-secondary btn-lg" style="background: #a71c21;">View Collection</a>
                            </div>
                        </div>
                                        ...
                                        <div class="product-box">
                                            ...
                                            <div class="product-image">
                                                ...
                                                <div class="button-set style1">
                                                    <!--Cart Button-->
                                                    <a href="#addtocart-modal" class="btn-icon addtocart quick-shop-modal" data-bs-toggle="modal" data-bs-target="#addtocart_modal">
                                                    ...
                                                    <!--Wishlist Button-->
                                                    <a href="javascript:void(0)" class="btn-icon wishlist" data-bs-toggle="tooltip" data-bs-placement="left" title="Add To Wishlist"><i class="icon anm anm-heart-l"></i><span class="text">Add To Wishlist</span></a>
                                                    <!--End Wishlist Button-->
                                                    <!--Compare Button-->
                            ...
                            <div class="testimonial-slider-3items gp15 slick-arrow-dots arwOut5">
                                <div class="testimonial-slide">
                                    <div class="testimonial-content text-center">     
                                        <div class="quote-icon mb-3 mb-lg-4"><img class="blur-up lazyload mx-auto" data-src="<?php echo $path ?>assets/images/icons/demo1-quote-icon.png" src="<?php echo $path ?>assets/images/icons/demo1-quote-icon.png" alt="icon" width="40" height="40" /></div>
                                        <div class="content">  
                                            <div class="text mb-2"><p>Excellent Service</p></div>
                                        ...
                                        <div class="auhimg d-flex-justify-center text-left">
                                            <div class="image"><img class="rounded-circle blur-up lazyload" data-src="<?php echo $path ?>" src="<?php echo $path ?>" alt="Murali" width="65" height="65" /></div>
                                ...
                                <div class="testimonial-slide">
                                    <div class="testimonial-content text-center">                                                     
                                        ...
                                        <div class="auhimg d-flex-justify-center text-left">
                                            <div class="image"><img class="rounded-circle blur-up lazyload" data-src="<?php echo $path ?>" src="<?php echo $path ?>" alt="Sujith" width="65" height="65" /></div>
                                            <div class="auhtext ms-3">
                                ...
                                <div class="testimonial-slide">
                                    <div class="testimonial-content text-center">                                                     
                                        ...
                                        <div class="auhimg d-flex-justify-center text-left">
                                            <div class="image"><img class="rounded-circle blur-up lazyload" data-src="<?php echo $path ?>" src="<?php echo $path ?>" alt="Venkat" width="65" height="65" /></div>
                                            <div class="auhtext ms-3">
                                ...
                                <div class="testimonial-slide rounded-3">
                                    <div class="testimonial-content text-center">                                                     
                                        ...
                                        <div class="auhimg d-flex-justify-center text-left">
                                            <div class="image"><img class="rounded-circle blur-up lazyload" data-src="<?php echo $path ?>" src="<?php echo $path ?>" alt="Ganapathi" width="65" height="65"/></div>
                                            <div class="auhtext ms-3">
                        ...
                        <ul class="m-0 clearfix">
                            <li class="item d-flex justify-content-center align-items-center">
                                <a class="product-image rounded-3" href="product-layout1.html">
                                    <img class="blur-up lazyload" data-src="<?php echo $path ?>img/index\th-61153702.jpg" src="<?php echo $path ?>assets/images/products/cart-product-img1.jpg" alt="product" title="Product" width="120" height="170" />
                                </a>
                            ...
                            <li class="item d-flex justify-content-center align-items-center">
                                <a class="product-image rounded-3" href="product-layout1.html">
                                    <img class="blur-up lazyload" data-src="<?php echo $path ?>img/used\cup4.jpg" src="<?php echo $path ?>assets/images/products/cart-product-img2.jpg" alt="product" title="Product" width="120" height="170" />
                                </a>
                                <div class="product-details">
