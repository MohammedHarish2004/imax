                    ...
                    <table class="display" id="basic-1">
                      ...
                      <tbody>
                        <tr>
                          ...
                          <td>
                            <ul class="action">
                              <li class="edit"> <a href="Product_edit.php"><i class="bi bi-pencil-fill "></i></a></li>
                              <li class="delete"><a href="#"><i class="bi bi-trash3-fill ps-2"></i></a></li>
                              <li class="delete"><a href="#"><i class="bi bi-box-arrow-up-right ps-2"></i></a></li>
                            </ul>
                          </td>
                        </tr>
                      </tbody>
        ...
        success: function (response) {
          ...
          if (result.status == 'Success') {
            ...
            data.map(function (value) {
              ...
              var editButton =
                `<a href="Product_edit.php?id=${value.id}" class='btn btn-success me-2'><i class="ri ri-pencil-fill"></i></a>`;
              var viewButton =
                `<a href=".php?id=${value.id}" class='btn btn-success me-2'><i class="ri ri-share-box-fill"></i></a>`;
              dataTable.row.add([
                `<img src="product_clothes_images/${value.id}/${value.}" width="70" height="100"/>`,
                value.,
                value.,
                value.,
                value.,
