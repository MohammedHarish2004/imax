                        ...
                        if (result.status == 'Success') {
                            ...
                            data.map(function (value) {
                                ...
                                dataTable.row.add([
                                    value.id,
                                    value.,
                                    `<button type="button" class="btn btn-success edit_Size" data-id="${value.id}" data-bs-toggle="modal" data-bs-target="#edit"><i
                ...
                $.ajax({
                    ...
                    success:function (response){
                        ...
                        if(result.status == "Success")
                        {
                            ...
                            {
                                $("#edit_size").html(Edit_data[0].product_size);
                            }
                        }
                    }
                })
