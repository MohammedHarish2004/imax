...
<head>
    ...
    <title>IMAX | Product Color Creation</title>
...
<body>
                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="page-title-box">
                                ...
                                <h4 class="page-title">Product Color Creation</h4>
                            </div>
                        </div>
                    </div>
                    <!-- end page title -->
                                ...
                                <div class="card-body">
                                    <div class="row">
                                        <div class="col-lg-6">
                                            <div class="form">
                                                <div class="mb-3">
                                                    <label for="proSize" class="form-label">Product Color</label>
                                                    <input type="text" id="proColor" class="form-control"
                            ...
                            <div class="modal-content modal-filled bg-white">
                                <div class="modal-body p-4">
                                    ...
                                    <div class="text-center">
                                        ...
                                        <h4 class="pb-3 text-dark mb-2 " >Product Color Edit</h4>
                                        <div class="mb-3">
                                            <label for="edit_size"  class="form-label text-dark float-start">Product
                                                Size</label>
                                            <input type="text" style="border:.5px solid #9b9999;" class="form-control" id="edit_color">
                                        </div>
                                        <button type="button" class="btn btn-success my-2" id="update">Update</button>
                                        <button type="button" id="submit" class="btn text-white my-2 ms-2"
    ...
    <script>
                        ...
                        if (result.status == 'Success') {
                            ...
                            data.map(function (value) {
                                ...
                                dataTable.row.add([
                                    value.id,
                                    value.,
                                    `<button type="button" class="btn btn-success edit_Color" data-id="${value.id}" data-bs-toggle="modal" data-bs-target="#edit"><i
                                                                        class="bi bi-pencil-fill "></i></button>
                                     <button  type="button" class="btn btn-danger ms-2 delete_Product" data-id="${value.id}"><i class="ri ri-delete-bin-5-fill"></i></button>`
                                ]).draw(false);
                            });
                        }
                    }
                ...
                $.ajax({
                    ...
                    success:function (response){
                        ...
                        if(result.status == "Success")
                        {
                            ...
                            {
                                $("#edit_color").html(Edit_data[0].product_size);
                            }
                        }
                    }
                })
        ...
        // sending id of update button in mobile to reflect in table
        ...
        $("#update").click(function(){
            ...
            var input1 = $("#edit_color").val();
            fd.append("edit_Color",input1);
