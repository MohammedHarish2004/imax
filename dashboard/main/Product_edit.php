                ...
                $.ajax({
                    ...
                    success: function (response) {
                        ...
                        if (result.status == 'Success') {
                            ...
                            document.getElementById('proImage').value = proImage;
                            document.getElementById('proName').value = proName;
                            document.getElementById('proPrice').value = proPrice;
                            document.getElementById('proSize').value = proSize;
                            document.getElementById('proColor').value = proColor;
